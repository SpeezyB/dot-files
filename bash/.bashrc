...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias ls='ls -halFC --color=auto --group-directories-first'
fi
    alias l='ls -halFC --color=auto --group-directories-first'
    alias ll='ls -halFG --color=auto --group-directories-first'
    alias c='cd ..'
    alias cls='clear'
    alias op='cd $OLDPWD'
    alias r='ranger'
    ...
    alias up='sudo apt-get update && sudo apt-get upgrade'
		alias ipup='/home/pi/.ipupdate/updateip.rb'
		alias ipup2='/home/pi/.ipupdate/2updateip.rb'
		alias rw='retro_welcome'
    ...
    alias ipbkup='scp ~/.ipupdate/* ben@192.168.0.11:/home/ben/Dropbox/code/upip/'
